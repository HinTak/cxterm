...
extern void DisownSelection (register XtermWidget termw);
extern void Scroll (register TScreen *screen, register int amount);
extern void RevScroll (register TScreen *screen, register int amount);
 ...
 */
void CursorSet(register TScreen *screen, register int row, register int col, unsigned int flags)
{
	register int maxr;
 ...
 */
void CursorBack(register TScreen *screen, int n)
{
 ...
 */
void CursorForward(register TScreen *screen, int n)
{
	screen->cur_col += n;
 ...
 */
void CursorDown(register TScreen *screen, int n)
{
	register int max;
 ...
 */
void CursorUp(register TScreen *screen, int n)
{
	register int min;
 ...
 */
void Index(register TScreen *screen, register int amount)
{
	register int j;
 ...
 * Won't leave scrolling region. No carriage return.
 */
void RevIndex(register TScreen *screen, register int amount)
{
	/*
 ...
 */
void CarriageReturn(register TScreen *screen)
{
	screen->cur_col = 0;
	screen->do_wrap = 0;
	_CheckSelection(screen);
 ...
 */
void CursorSave(register XtermWidget term, register SavedCursor *sc)
{
 ...
 */
void CursorRestore(register XtermWidget term, register SavedCursor *sc)
{
	register TScreen *screen = &term->screen;
	...
	term->flags &= ~(BOLD|BLINK|INVERSE|UNDERLINE|ORIGIN);
	term->flags |= sc->flags & (BOLD|BLINK|INVERSE|UNDERLINE|ORIGIN);
