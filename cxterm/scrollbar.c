/* $Id: scrollbar.c,v 1.3 2003/05/06 07:40:19 htl10 Exp $ */
/***********************************************************************
...
void ResizeScrollBar(register Widget scrollWidget, int x, int y, unsigned int height)
{
...
void WindowScroll(register TScreen *screen, int top)
{
...
void ScrollBarOff(register TScreen *screen)
{
	if(!screen->scrollbar)
		return;
